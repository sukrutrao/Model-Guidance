...
def get_arch_builder(arch_name: str):
    ...
    if arch_name.startswith("resne"):
        ...
        arch_builder = getattr(inception, arch_name)
...
def get_model(model_config):
    ...
    model = bcos_common.BcosSequential(model, LogitBias(logit_bias))
